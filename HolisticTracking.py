...
colorDots = mp_drawing.DrawingSpec(color=(80,110,10), thickness=1, circle_radius=1)
colorConnects = mp_drawing.DrawingSpec(color=(80,256,121), thickness=1, circle_radius=1)
